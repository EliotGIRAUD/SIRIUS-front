...
export function LayeredDogStage({ colors: c }: Props) {
  return (
    <View style={styles.root} collapsable={false}>
      <Svg style={styles.svg} width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
        <Defs>
        ...
        <Path d="M0,48 Q18,36 38,42 Q55,38 72,44 Q88,40 100,46 L100,100 L0,100 Z" fill={c.sceneHillFar} opacity={0.95} />

        <Path d="M0,56 Q22,50 48,54 Q72,50 100,56 L100,100 L0,100 Z" fill={c.sceneHillMid} opacity={0.92} />

        <Path d="M0,68 Q28,64 50,66 Q72,64 100,68 L100,100 L0,100 Z" fill={c.sceneGroundShadow} opacity={0.55} />
        ...
        <G>
          ...
          <Path d="M 64 74 Q 76 60 82 44" stroke={c.dogVectorBody} strokeWidth={4.5} strokeLinecap="round" fill="none" />
          ...
          <Ellipse cx={50} cy={58} rx={3} ry={5} fill={c.dogVectorTongue} />
